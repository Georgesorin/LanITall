...
def generate_all():
    ...
    # Whack-A-Mole Specific Sounds
    save_wav("good_hit.wav", generate_tone(1200, 0.1, vol=0.3, type='square', slide=800))  # Happy coin blip
    save_wav("bad_hit.wav", generate_tone(150, 0.25, vol=0.4, type='saw', slide=-50))      # Angry buzzer
...
if __name__ == "__main__":
    generate_all()
    print("Whack-A-Mole sounds generated successfully!")